...
**** Need to talk about comparison of two sites and talk about microburst spike in service - and the fact we had this feature enabled.  If not enabled, we would never have seen this.

* Choose:
  * Device: CHI-EDGE01 and SFO-EDGE01
  * Objects: GigabitEthernet1/1/0/0 (CHI) and GigabitEthernet1/1/0/0 (SFO)
  * Indicators: Total HC Octets (CHI) and Total HC Octets (SFO)
![Lab 3](images/WAN/Step8d.png)

...
The workflow should be listed as “SevOne Ingest Data - APIv3 (new v3 version)”.

## Step 3:

Create a new workflow like we did previously (click “Create Workflow”) and name it “Lab3”. 

- Navigate to [ Home > User > “SevOne Ingest Data - APIv3 (new v3 version)” ] and drop it under the Assign_1 block
...
```
*A few things to note. You may want to update the above "timestamp" with the current time. To do this you will need to pull the EPOCH Unix time from somewhere like (https://www.epochconverter.com/). Also note that this is just sample data. This example adds a new device "Sacramento02" and an object "Speedtest"*
...
#### Note: In the screenshot above you will notice a few comment lines. Add a few and document your code. [ Home > Common > Comment ]

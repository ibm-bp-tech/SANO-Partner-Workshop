...
This lab will show how we can monitor the internet connections from a holistic approach. Not only are 
we able to monitor internet traffic, but we can get visibility from every single aspect of the network 
that could impact the internet connections. From BGP connections to MPLS traffic, from QoS drops to 
bandwidth analysis – we can see it all.
...
* Talking Points: 
  ...
  * However we need more detailed information because this microburst could be another reason why there are QoS drops 
